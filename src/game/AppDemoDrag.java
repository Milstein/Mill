 ...
 */
public class AppDemoDrag {
  JLabel label;

  static String starFile = "Black_Stone.png";
  ...
  protected static ImageIcon createImageIcon(String path) {
    java.net.URL imgURL = AppDemoDrag.class.getResource(path);
    if (imgURL != null) {
  ...
  private static void createAndShowGUI() {
    ...
    JFrame frame = new JFrame("AppDemoDrag");
    frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

    //Set up the content pane.
    AppDemoDrag controller = new AppDemoDrag();
  ...
  private class SelectionArea extends JLabel {
    ...
    AppDemoDrag controller;

    public SelectionArea(ImageIcon image, AppDemoDrag controller) {
